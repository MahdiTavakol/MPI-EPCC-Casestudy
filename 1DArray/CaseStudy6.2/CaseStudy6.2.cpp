...
int main(int argc, char** argv)
{
    ...
    for (int l = 0; l < iteration; l++)
    {
        ...
        int indx0 = (Np+2)*1;
        int indx1 = (Np+2)*(Mp+1);
        MPI_Issend(&old[indx0],Np,MPI_DOUBLE,left_proc,tag1,world,&request1);
        MPI_Irecv(&old[indx1],Np,MPI_DOUBLE,right_proc,tag1,world,&request2);
        int tag2  = 1;
        int indx2 = (Np+2)*Mp;
        int indx3 = 0;
        MPI_Issend(&old[indx2],Np,MPI_DOUBLE,right_proc,tag2,world,&request3);
        MPI_Irecv(&old[indx3],Np,MPI_DOUBLE,left_proc,tag2,world,&request4);
